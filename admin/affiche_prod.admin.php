...
if($dep=='homme')
{
    ...
    <div class="container"> 
        ...
        getproduct_admin($dep,$cat,"#1E1A1D");
}
else if($dep=='femme')
{
    echo '
    <center><h1 style="margin-top:50px;">ESPACE DES FEMMES</h1></center>
    <div class="container"> 
            <div class="row">
                <img src="../image_site/femme_banner.jpg" class="img-responsive" alt="banner" id="banner_home">
            </div>
        </div>';
        getproduct_admin($dep,$cat,"#F1558E");
}
else
{
    echo '
    ...
    <div class="container"> 
        ...
        getproduct_admin($dep,$cat,"#39BFD0");
}
